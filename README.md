...
> **Swift 6 note:** All ViewModels must be `@MainActor`-isolated. The compiler enforces this strictly: any UI state mutation from a background context is a compile error, not a runtime crash.
